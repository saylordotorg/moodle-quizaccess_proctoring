...
- The access tests now build the admin tree and assert the page grants a site administrator and a manager and refuses everyone else. The existing tests only exercised the helper the *other* pages use, which is why a page that refused everybody shipped green.
