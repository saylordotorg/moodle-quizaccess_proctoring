...
if (quizaccess_proctoring_is_facematch_method_enabled($fcmethod)) {
    if (!quizaccess_proctoring_facematch_credentials_available($fcmethod)) {
        redirect(
            $redirecturl,
        ...
        quizaccess_proctoring_analyze_specific_quiz($courseid, $cmid, $studentid, $redirecturl);
        redirect(
            $redirecturl,
