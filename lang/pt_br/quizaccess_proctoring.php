...
$string['captchamode_help'] = 'Controla se os alunos devem concluir o Moodle reCAPTCHA antes de iniciar uma nova tentativa de questionário monitorado. Herdar usa a configuração global do Saylor Proctored Quiz.';
...
$string['setting:captchabeforeattemptenabled_desc'] = 'Se habilitado, os alunos devem concluir o Moodle reCAPTCHA antes de iniciar uma nova tentativa de questionário monitorado. As chaves pública e privada de reCAPTCHA do site Moodle devem estar configuradas.';
