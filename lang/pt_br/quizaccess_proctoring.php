...
$string['setting:blockclipboard_desc'] = 'Se habilitado, as ações normais de copiar, recortar e colar do navegador são bloqueadas durante tentativas monitoradas e registradas como eventos da área de transferência.';
