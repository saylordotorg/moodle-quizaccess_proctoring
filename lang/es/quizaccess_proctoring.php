...
$string['plugin_description'] = 'El complemento saylorprocotring mejora la seguridad de los cuestionarios en línea capturando y verificando la identidad de los usuarios mediante imágenes de la cámara web. Está diseñado para garantizar que solo los usuarios autorizados puedan realizar el cuestionario, ofreciendo una solución de supervisión segura y fiable.';
...
$string['requireentirescreen_help'] = 'Controla si los estudiantes deben compartir toda la pantalla antes de que se habiliten los controles para iniciar el cuestionario. Heredar usa la configuración global de saylorprocotring.';
...
$string['users_list'] = 'Lista de usuarios de saylorprocotring';
