...
$string['desktopcaptureprompt'] = 'Share your entire screen so violation events can include a desktop capture.';
...
$string['requireentirescreen_help'] = 'Controls whether students must share their entire screen before the quiz start controls are enabled. Inherit uses the site-wide saylorprocotring setting.';
...
$string['setting:blockclipboard_desc'] = 'If enabled, normal browser copy, cut, and paste actions are blocked during proctored quiz attempts and logged as clipboard events.';
