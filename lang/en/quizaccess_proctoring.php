...
$string['plugin_description'] = 'The saylorprocotring plugin enhances the security of online quizzes by capturing and verifying user identities through webcam images. It is designed to ensure that only authorized users can attempt the quiz, providing a secure and reliable proctoring solution.';
...
$string['setting:custom_ai_endpoint'] = 'Custom AI endpoint URL';
$string['setting:custom_ai_endpoint_desc'] = 'The URL of the custom face match API endpoint, for example http://your-server-ip:8000/verify.';
...
$string['users_list'] = 'saylorprocotring Users list';
