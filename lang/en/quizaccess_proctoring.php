...
$string['captchamode_help'] = 'Controls whether students must complete Moodle reCAPTCHA before starting a new proctored quiz attempt. Inherit uses the site-wide Saylor Proctored Quiz setting.';
...
$string['setting:captchabeforeattemptenabled_desc'] = 'If enabled, students must complete Moodle reCAPTCHA before starting a new proctored quiz attempt. Moodle site reCAPTCHA public and private keys must be configured.';
