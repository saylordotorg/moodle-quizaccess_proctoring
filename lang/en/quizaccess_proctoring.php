...
$string['preflight:requirementsintro'] = 'Complete each required item below. The Start attempt button appears after every item is complete.';
...
$string['screenmonitor:minimize'] = 'Minimize';
...
$string['screenmonitor:restore'] = 'Restore';
